...
def create_model(opt):
    ...
    elif model == 'condition_and_base':
        from .Generation_condition_and_base_model import GenerationModel as M
    elif model == 'tonemapping_GAN':
        from .Generation_tonemapping_GAN_model import GenerationModel as M
